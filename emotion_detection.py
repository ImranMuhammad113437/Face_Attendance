...
class Emotion_Detection:
    def __init__(self, root,username):
        ...
        save_button = Label(self.main_frame2, text="Emotion Detection Testing", bg="orange", fg="white", font=("New Time Roman", 20, "bold"))
        save_button.place(x=80, y=10, width=350, height=40)  # Positioned next to the back button
