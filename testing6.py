...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def display_student_info(self):
        ...
        for course in selected_courses:
            ...
            # Create table header
            Label(table_frame, text="Date" + "Hour" + "Status", bg="white", fg="black").pack(padx=5)
            Label(table_frame, text="Hour", bg="white", fg="black").pack(padx=5)  # New header for course_hour
            Label(table_frame, text="Status", bg="white", fg="black").pack(padx=5)
        ...
        Label(self.content_frame, text="Selected Options:", bg="white", fg="black").pack(anchor="w", padx=10, pady=5)
