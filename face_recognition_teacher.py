...
class Face_Recognition_Teacher:
    def __init__(self, root, username):
        ...
        Label(main_frame, text="Face Recognition (Teacher)", bg="orange", fg="white", font=("New Time Roman", 20, "bold")).place(relx=0.5, rely=0.5, anchor=CENTER)
